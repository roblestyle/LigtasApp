  ...
  return (
    <div className="h-full px-1 py-3 w-64 bg-red-950 rounded-xl p-4">
      ...
      <div className="flex justify-center">
        <hr className="border-t-1 border-white w-64 my-5" />
      </div>
      <ul className="space-y-2 mx-4 font-medium">
        <li>
          <a
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className="size-6 hover:text-red-950"
            >
              <path
                fillRule="evenodd"
            ...
            <span className="ms-3">Map Dashboard</span>
          </a>
        </li>
        <li>
          <a
